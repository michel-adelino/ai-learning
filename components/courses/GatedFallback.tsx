...
const TIER_GRADIENT_MUTED: Record<Tier, string> = {
  ...
  pro: "from-zinc-500/20 to-zinc-600/20",
    ...
    >
      ...
      <div className="relative z-10 max-w-xl mx-auto text-center">
        ...
        <Link href="/pricing">
          <Button
            size="lg"
            className="bg-linear-to-r from-zinc-600 to-zinc-500 hover:from-zinc-500 hover:to-zinc-400 text-white border-0 shadow-xl shadow-zinc-600/30 px-8"
          >
