...
export function ModuleAccordion({ modules, completedLessonIds = [] }: ModuleAccordionProps) {
                ...
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex-1 text-left min-w-0">
                    ...
                    <p className="text-sm text-zinc-500 mt-1">
                      ...
                      {completedLessonIds.length > 0 && total > 0 && (
                        <span className="ml-2">
                      ...
                      >
                        ...
                        <span
                          className={`flex-1 text-sm ${
                            lessonCompleted ? "text-zinc-400" : "text-zinc-300"
